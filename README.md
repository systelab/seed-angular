...
In order to run the application, you need a backend. A JEE Backend is implemented in the [systelab/seed-jee][https://github.com/systelab/seed-jee] repository.
